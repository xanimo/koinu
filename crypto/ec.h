...
#ifndef DOGEWALLET_EC_H
#define DOGEWALLET_EC_H

#include <stddef.h>
#include <stdint.h>

#define DW_EC_SECKEY_LEN   32
#define DW_EC_PUBKEY_LEN   33     /* compressed */
#define DW_EC_SIG_DER_MAX  72     /* longest DER-encoded ECDSA signature */
