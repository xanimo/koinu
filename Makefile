...
CORE_SRC = crypto/rng.c crypto/mem.c crypto/sha2.c crypto/ripemd160.c crypto/hmac.c crypto/ec.c
CORE_OBJ = $(CORE_SRC:.c=.o)

LIB   = libdogewallet.a
TESTS = test/test_rng test/test_sha2 test/test_ripemd160 test/test_hmac test/test_ec
